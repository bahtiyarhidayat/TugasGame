Public Class Form1
    ...
    Private Sub CountDown_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CountDown.Tick
        Time.Text = CStr(CDbl(Time.Text) - 1)
        If CDbl(Time.Text) < 1 Then
            MsgBox("Permainan Berakhir,Score Anda : " & Score.Text)
            If Int(CDbl(Score.Text)) > CDbl(HighScore.Text) Then
                MsgBox("Anda masuk highsore.")
